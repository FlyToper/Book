...
<link rel="shortcut icon" href="<?php echo (IMG_URL); ?>favicon.ico">
	...
	<link rel="stylesheet" rev="stylesheet"
		href="<?php echo (CSS_URL); ?>user.css" type="text/css" media="all" />
</head>
							...
							<td>
								...
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td colspan="2">&nbsp;&nbsp; <?php if($Info[0]['gender'] == 'man'): ?>&nbsp;&nbsp;<input
												type="radio" name="radiobutton" value="man"
												checked="checked" />男 <?php else: ?> &nbsp;&nbsp;<input
												type="radio" name="radiobutton" value="man" />男<?php endif; ?> <?php if($Info[0]['gender'] == 'woman'): ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
												name="radiobutton" value="woman" checked="checked" />女 <?php else: ?>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
												name="radiobutton" value="woman" />女<?php endif; ?> <?php if($Info[0]['gender'] == 'baomi'): ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
												name="radiobutton" value="baomi" checked="checked" />保密 <?php else: ?>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
												name="radiobutton" value="baomi" />保密<?php endif; ?></td>
									</tr>
									<tr>
										<td style="text-align: right">联系方式：</td>
										<td colspan="2"><input id="txtPhone" name="text2"
											type="text" class="textinput" value="<?php echo ($Info[0]['phone']); ?>" /></td>
									</tr>
									<tr>
										<td style="text-align: right">发货地址：</td>
										<td colspan="2"><input id="txtAddress" name="text"
											type="text" class="textinput" style="width: 350px"
											value="<?php echo ($Info[0]['shippingaddress']); ?>" /></td>
									</tr>
									<tr>
								...
								<table width="100%" border="0" cellspacing="2" class="upline">
									<tr>
										<td width="16%" style="text-align: right; width: 20%">已选问题：</td>
										<td width="47%" style="width: 50%"><?php echo ($Info[0]['findpwdquestion']); ?></td>
										<td></td>
									</tr>
									<tr>
										<td width="16%" style="text-align: right; width: 20%">密码保护问题：</td>
										<td width="47%" style="width: 50%"><select
											id="selectQuestion" name="select" class="textinput"
											style="width: 230px; height: 26px; border-radius: 6px;">
												<option value="0">- 选择一个问题 -</option>

												<?php if(is_array($Answer)): foreach($Answer as $key=>$answer): if(trim($Info[0]['findpwdquestion']) == trim($answer.question)): ?><option value="<?php echo ($Info[0]['findpwdquestion']); ?>"
													selected="selected"><?php echo ($Info[0]['findpwdquestion']); ?></option>
												<?php else: ?>
									...
									<tr>
										...
										<td colspan="2"><input id="txtAnswer" name="text3"
              ...
              <td>&nbsp;</td>
								...
								<table width="100%" border="0" cellspacing="2" class="upline">
									<tr>
										...
										<td style=""><input id="txtCode" name="text4" type="text"
											class="textinput" /></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<td style="text-align: right; width: 20%"></td>
										<td style="padding-left: 2%;"><img
											style="border-style: solid; border-width: 1px; border-radius: 6px; border-color: gray"
											id="imgModifyUserInfoCode"
											src="/User/createModifyUserInfoCode" alt="验证密"
											onclick="updateImgCode()" /></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<td style="text-align: right">&nbsp;</td>
										<td>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)"
											onclick="updateImgCode()">看不清？换一张</a></td>
										<td>&nbsp;</td>
									</tr>
								</table>
								...
								<p style="text-align: center">
									<a href="javascript:void(0);"><img
										src="<?php echo (IMG_URL); ?>botton_gif_025.gif" border="0"
										onclick="btnModifyUserInfo()" /></a>
								</p>
  ...
  <table width="100%" border="0" cellspacing="0">
	...
	<script type="text/javascript">
		...
		function updateImgCode() {
			var s = Math.random();
			$("#imgModifyUserInfoCode").attr("src",
					"./createModifyUserInfoCode/s/" + s);
		}

		//提交更新用户个人信息
		function btnModifyUserInfo() {
			var gender = $("input:radio[name=radiobutton]:checked").val();
			var phone = $("#txtPhone").val();
			var address = $("#txtAddress").val();
			var question = $("#selectQuestion").val();
			var answer = $("#txtAnswer").val();
			var code = $("#txtCode").val();
			//alert(gender+"___"+phone+"___"+address+"___"+answer);
			...
			if (gender != "") {
				if (phone != "") {
					if (address != "") {
						...
						alert(question + "___" + answer + "___" + code);
					} else {
						alert("发货地址不能为空！");
					}
				} else {
