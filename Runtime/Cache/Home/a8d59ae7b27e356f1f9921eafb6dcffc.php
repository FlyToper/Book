  ...
  <table width="100%" border="0" cellspacing="0">
    <tr>
      <td width="25%"><table width="100%" border="0" cellspacing="0" style="margin-top:30px">
        ...
        <tr>
          <td class="listtd"><img src="<?php echo (IMG_URL); ?>/miniicon.gif" width="9" height="6" />&nbsp;&nbsp;&nbsp;&nbsp;<a href="news.html">普通快递送货上门</a></td>
        </tr>
...
<a href="news.html">普通邮寄</a></td>
      ...
      <td><div style="text-align:right; margin:5px 10px 5px 0px"><a href="index.html">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;购物车</div>
        ...
        <tr>
          <td><img src="<?php echo (AD_URL); ?>/page_ad.jpg" width="666" height="89" />
            <table width="100%" border="0" cellspacing="0">
              <tr>
                <td><img src="<?php echo (IMG_URL); ?>/buy1.gif" width="635" height="38" /></td>
              </tr>
              <tr>
                <td><table cellspacing="1" class="carttable">
                  ...
                  <table width="100%" border="0" cellspacing="0">
				   ...
				   <div style="text-align:right; margin-top:10px"><a href="product_list.html"><img src="<?php echo (IMG_URL); ?>/gwc_jx.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="order.html"><img src="<?php echo (IMG_URL); ?>/gwc_buy.gif" border="0" /></a></div>
